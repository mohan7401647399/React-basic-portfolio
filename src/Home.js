                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <ul class="skills">
                                        <li>
                                            Front-end languages, HTML - CSS - JS - REACTJS
                                        </li>
                                        <li>
                                            Back-end languages, JAVA - PYTHON - NODEJS
                                        </li>
                                        <li>
                                            Dabases languages, Mysql, MongoD
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-4">
                                    <h2 class="myskills">Internship Certifications</h2>
                                    <br></br>
                                    <ul class="skills">
                                        <li>I learn React in vj</li>
                                        <li>I learn JS  in Dhuddu</li>
                                    </ul>
                                </div>
                                <br></br>
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <br></br>
                                        <table class="table table-success table-hover table">
                                            <thead>
                                            <tr>
                                                <th>Degree</th>
                                                <th>School / Clg</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>12th</td>
                                                    <td>Vallal.S.I.Alagarsami.school</td>
                                                    <td>2012</td>
                                                </tr>
                                                <tr>
                                                    <td>B.A</td>
                                ...
                                <div >
                                    <ul class="nav justify-content-center gap-5">
                                        <li class="nav-item">
                                            <a href="https://www.facebook.com/" style={{color:"red"}}>
                                            < FaFacebookMessenger/>
                                            </a>
                                         </li>
                                         <br></br>                                         
                                         ...
                                         <br></br>  
                                         <li class="nav-item">
                                            <a href="https://www.youtube.com/" style={{color:"purple"}}>
                                            < TfiYoutube/>
                                            </a>
                                         </li>
                                    </ul>
